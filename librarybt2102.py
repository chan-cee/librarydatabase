...
myButtonb = Button(reserve_cancel_frame, text = "Book Reservation", fg = "black", bg = "#8789C0", padx = 200, pady = 50, command = lambda: change_frame(reservation_frame, reserve_cancel_frame))
myButtonr = Button(reserve_cancel_frame, text = "Reservation Cancellation", fg = "black", bg = "#8789C0", padx = 200, pady = 50, command = lambda: change_frame(cancel_reservation_frame, reserve_cancel_frame))
#myButtonr.pack()
